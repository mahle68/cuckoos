# Here we are going to recreate the occurrence distribution of Leroy the cat in Appendix D.
# First you will need to install the ctmm package from CRAN (v0.3.0 or better).
# Next we are going to import Leroy's data from the move package and convert it into the ctmm telemetry format.
# move is only a suggested package for ctmm and so you will have to install that as well.
library(ctmm)
